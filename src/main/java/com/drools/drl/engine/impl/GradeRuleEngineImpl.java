package com.drools.drl.engine.impl;

import com.drools.drl.domain.GradeDomain;
import com.drools.drl.engine.GradeRuleEngine;
...
public class GradeRuleEngineImpl implements GradeRuleEngine {
    ...
    private List<Reader> readRuleFromDrlFile() {
        ...
        drlFilePath.add("D:/Project/IdeaProjects/src/main/resources/drl/addpoint.drl");
        drlFilePath.add("D:/Project/IdeaProjects/src/main/resources/drl/subpoint.drl");
